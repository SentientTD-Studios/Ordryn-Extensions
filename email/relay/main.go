// HTTPS-to-SMTP relay for examples/extensions/email.
...
func main() {
	...
	log.Printf("email relay listening on %s (MAIL_TO=%s)", listen, mustEnv("MAIL_TO"))
...
func handle(w http.ResponseWriter, r *http.Request) {
	...
	subj := strings.TrimSpace(p.Project)
	if p.Name != "" {
		if subj != "" {
			subj += ": "
		}
	...
	if err := sendSMTP(subj, text); err != nil {
